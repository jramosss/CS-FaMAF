...
Si no encuentro a mi personaje en la primera posicion, empiezo a 
correr la etiqueta "corridaP", la cual es una corrida de puntero,
esta simplemente hace el mismo recorrido del ejercicio 1 pero con
instrucciones abajoP, arribaP,... que en vez de swapear de posicion,
aumentan o decrementan el puntero hacia esa posicion.
Mientras hago esto, llevo la cuenta de cuantas instrucciones voy corriendo,
este dato me sirve para cuando encuentre a mi personaje, ya que una vez que 
lo encuentre, tengo que seguir la rutina pero con las instrucciones reales de 
abajo, arriba, esto lo guardo en X6, una vez que lo encuentro, directamente
empiezo a correr la etiqueta corrida normalmente.
*/
